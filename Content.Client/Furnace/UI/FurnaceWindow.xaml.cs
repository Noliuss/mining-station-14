...
namespace Content.Client.Furnace.UI
{
    ...
    public sealed partial class FurnaceWindow : DefaultWindow
    {
        ...
        public void UpdateState(BoundUserInterfaceState state)
        {
            ...
            tempText.Append(Loc.GetString("gas-analyzer-window-temperature-val-text",
                        ("tempK", $"{castState.Temperature:0.#}"),
                        ("tempC", $"{TemperatureHelpers.KelvinToCelsius(castState.Temperature):0.#}")));
